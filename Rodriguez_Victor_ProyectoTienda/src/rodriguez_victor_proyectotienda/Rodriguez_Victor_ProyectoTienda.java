package rodriguez_victor_proyectotienda;

import java.util.Scanner;

public class Rodriguez_Victor_ProyectoTienda {
        ...
        do {
            ...
            if (op > 6 || op < 1) {
                ...
                switch (op) {
                    ...
                    case 2:
                        if (!cajaAbierta || efectivoCaja <= 0) {
                            System.out.println("No hay efectivo suficiente o la caja no ha sido abierta, por favor abra caja!!!");
                            break;
                        }
                        ...
                        while (!compra) {
                            System.out.println("\n--- Stock Disponible ---");
                            System.out.println("Codigo 1: Azucar - " + azucar + " kg");
                            System.out.println("Codigo 2: Avena  - " + avena + " kg");
                            System.out.println("Codigo 3: Trigo  - " + trigo + " kg");
                            System.out.println("Codigo 4: Maiz   - " + maiz + " kg");
    ...
    System.out.println("--- Tabla de productos y codigos ---");
    System.out.println("+---------+---------+");
    ...
    if (puedeComprarProv) {
        ...
        System.out.println("Proveedor NO vende dicho producto.");
                    ...
                    case 5:
                        ...
                        System.out.print("Cuanto efectivo desea depositar en el banco? (max 60%): ");
                        ...
                        if (aDepositar > maxDeposito) {
                            System.out.println("No puede depositar mas del 60%. Se depositara el maximo permitido.");
